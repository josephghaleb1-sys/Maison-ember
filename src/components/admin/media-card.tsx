    ...
    <div className="overflow-hidden rounded-xl border border-charcoal-800">
      ...
      <div className="space-y-2 p-3">
        <div className="flex items-center justify-between gap-2">
          <Badge className={cn(media.kind === "gallery" && "bg-accent-500/15 text-accent-300")}>
        ...
        <input
          ...
          className="w-full rounded-md border border-charcoal-700 px-2 py-1 text-xs text-charcoal-200 focus:border-accent-500 focus:outline-none disabled:opacity-60"
        />
